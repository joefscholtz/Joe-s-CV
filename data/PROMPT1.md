...
- RULE A (Quantity Match): For EVERY selected experience, count how many skills have "is_default": true in the DATABASE. You MUST select exactly that same number of IDs for your output.
